        ...
        for d in range(0, rows):
            for c in range(0, cols):
                ...
                cv2.putText(ver, lables[d][c], (eachImgWidth * c + 10, eachImgHeight * d + 20), cv2.FONT_HERSHEY_COMPLEX,
                            0.7, (255, 0, 255), 2)
    return ver
cap1 = cv2.VideoCapture('ikun1.mp4')
cap2 = cv2.VideoCapture('ikun2.mp4')
while True:
    ret1,img1 = cap1.read()
    ret2,img2 = cap2.read()
    img1 = cv2.resize(img1,(1200,1080))
    img2 = cv2.resize(img2,(1200,1080))
    img1 = detector.findPose(img1)
    imgStack = stackImages(([img1,img2]),0.5)
